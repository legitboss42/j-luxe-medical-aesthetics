  ...
  return (
    <>
      ...
      <section className="rounded-2xl border border-white/12 bg-black/35 p-5">
        ...
        <SignaturePadField id="customerSignatureBody" name="customerSignatureBody" label="Customer Signature" required />
        ...
        <SignaturePadField id="employeeSignatureBody" name="employeeSignatureBody" label="Employee Signature" />
