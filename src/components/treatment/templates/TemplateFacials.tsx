...
export default function TemplateFacials({
  ...
  return (
    <>
      ...
      <section className="rounded-2xl border border-white/12 bg-black/35 p-5">
        <p className="text-base font-bold uppercase tracking-[0.12em] text-[#E7C97C]">Fitzpatrick Skin Type Assessment</p>
      ...
      <section className="rounded-2xl border border-white/12 bg-black/35 p-5">
        ...
        <SignaturePadField id="signatureFacial" name="signatureFacial" label="Customer Signature" required />
        ...
        <SignaturePadField id="employeeSignatureFacial" name="employeeSignatureFacial" label="Employee Signature" />
