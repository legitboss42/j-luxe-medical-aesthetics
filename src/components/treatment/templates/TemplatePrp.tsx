  ...
  return (
    <>
      ...
      <section className="rounded-2xl border border-white/12 bg-black/35 p-5">
        ...
        <SignaturePadField id="signaturePrp" name="signaturePrp" label="Customer Signature" required />
        ...
        <SignaturePadField id="employeeSignaturePrp" name="employeeSignaturePrp" label="Employee Signature" />
