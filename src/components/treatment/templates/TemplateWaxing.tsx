  ...
  return (
    <>
      ...
      <section className="rounded-2xl border border-white/12 bg-black/35 p-5">
        ...
        <SignaturePadField id="signatureWaxing" name="signatureWaxing" label="Customer Signature" required />
        ...
        <SignaturePadField id="employeeSignatureWaxing" name="employeeSignatureWaxing" label="Employee Signature" />
