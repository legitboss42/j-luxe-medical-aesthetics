  ...
  return (
    <>
      <section className="rounded-2xl border border-white/12 bg-black/35 p-5">
        <p className="text-base font-bold uppercase tracking-[0.12em] text-[#E7C97C]">Medical History & Oral Analysis</p>
      ...
      <section className="rounded-2xl border border-white/12 bg-black/35 p-5">
        ...
        <SignaturePadField id="signatureTeeth" name="signatureTeeth" label="Customer Signature" required />
        ...
        <SignaturePadField id="employeeSignatureTeeth" name="employeeSignatureTeeth" label="Employee Signature" />
